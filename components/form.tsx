  ...
  return (
    <div id="form" ref={formRef}>
      <iframe
        ...
        frameBorder="0"
        className="rounded-lg shadow-lg bg-[#0A0A0A] border border-white/[0.08] w-[400px] h-[660px] md:w-[400px] md:h-[620px] border-none max-w-full min-w-[300px] sm:min-w-[400px]"
